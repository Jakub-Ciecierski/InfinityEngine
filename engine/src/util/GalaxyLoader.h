...
#define MAX_MW_DISK_COUNT 16384 / 1
#define MAX_AND_DISK_COUNT 16384 / 1

// old
#define MAX_DISK_COUNT DISK_COUNT / GLX_SKIP

#define BULGE_COUNT 8192
#define MAX_MW_BULGE_COUNT 8192 / 1
#define MAX_AND_BULGE_COUNT 8192 / 1

// old
#define MAX_BULGE_COUNT BULGE_COUNT / GLX_SKIP

#define HALO_COUNT 16384
#define MAX_MW_HALO_COUNT 16384 / 1
#define MAX_AND_HALO_COUNT 16384 / 1
