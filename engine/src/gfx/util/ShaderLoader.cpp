...
GLuint LoadShaders2(const char* vertex_file_path, const char* fragment_file_path)
{
    ...
    }else {  fprintf(stderr, "VertexShader failed to load\n"); }
    ...
    } else { fprintf(stderr, "FragmentShader failed to load\n"); }
...
GLuint LoadShaders4(const char* vertex_file_path, const char* fragment_file_path)
{
